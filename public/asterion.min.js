...
G(f)||(f=!0),G(g)||(g=!1),c.on("click",function(){a.$apply(function(){e.$setViewValue(c[0].checked)})}),e.$render=function(){c[0].checked=e.$viewValue},e.$isEmpty=function(a){return a!==f},e.$formatters.push(function(a){return a===f}),e.$parsers.push(function(a){return a?f:g})},hidden:v,button:v,submit:v,reset:v,file:v},Ye=["badInput"],hc=["$browser","$sniffer",function(a,c){return{restrict:"E",require:"?ngModel",link:function(d,e,f,g){g&&(Rc[x(f.type)]||Rc.text)(d,e,f,g,c,a)}}}],wb="ng-valid",xb="ng-invalid",Ra="ng-pristine",zb="ng-dirty",Ze=["$scope","$exceptionHandler","$attrs","$element","$parse","$animate",function(a,c,d,e,f,g){function h(a,c){c=c?"-"+nb(c,"-"):"",g.removeClass(e,(a?xb:wb)+c),g.addClass(e,(a?wb:xb)+c)}this.$modelValue=this.$viewValue=Number.NaN,this.$parsers=[],this.$formatters=[],this.$viewChangeListeners=[],this.$pristine=!0,this.$dirty=!1,this.$valid=!0,this.$invalid=!1,this.$name=d.name;var k=f(d.ngModel),m=k.assign;if(!m)throw z("ngModel")("nonassign",d.ngModel,ia(e));this.$render=v,this.$isEmpty=function(a){return F(a)||""===a||null===a||a!==a};var l=e.inheritedData("$formController")||yb,n=0,q=this.$error={};e.addClass(Ra),h(!0),this.$setValidity=function(a,c){q[a]!==!c&&(c?(q[a]&&n--,n||(h(!0),this.$valid=!0,this.$invalid=!1)):(h(!1),this.$invalid=!0,this.$valid=!1,n++),q[a]=!c,h(c,a),l.$setValidity(a,c,this))},this.$setPristine=function(){this.$dirty=!1,this.$pristine=!0,g.removeClass(e,zb),g.addClass(e,Ra)},this.$setViewValue=function(d){this.$viewValue=d,this.$pristine&&(this.$dirty=!0,this.$pristine=!1,g.removeClass(e,Ra),g.addClass(e,zb),l.$setDirty()),r(this.$parsers,function(a){d=a(d)}),this.$modelValue!==d&&(this.$modelValue=d,m(a,d),r(this.$viewChangeListeners,function(a){try{a()}catch(d){c(d)}}))};var p=this;a.$watch(function(){var c=k(a);if(p.$modelValue!==c){var d=p.$formatters,e=d.length;for(p.$modelValue=c;e--;)c=d[e](c);p.$viewValue!==c&&(p.$viewValue=c,p.$render())}return c})}],Fd=function(){return{require:["ngModel","^?form"],controller:Ze,link:function(a,c,d,e){var f=e[0],g=e[1]||yb;g.$addControl(f),a.$on("$destroy",function(){g.$removeControl(f)})}}},Hd=aa({require:"ngModel",link:function(a,c,d,e){e.$viewChangeListeners.push(function(){a.$eval(d.ngChange)})}}),ic=function(){return{require:"?ngModel",link:function(a,c,d,e){if(e){d.required=!0;var f=function(a){return d.required&&e.$isEmpty(a)?void e.$setValidity("required",!1):(e.$setValidity("required",!0),a)};e.$formatters.push(f),e.$parsers.unshift(f),d.$observe("required",function(){f(e.$viewValue)})}}}},Gd=function(){return{require:"ngModel",link:function(a,c,d,e){var f=(a=/\/(.*)\//.exec(d.ngList))&&RegExp(a[1])||d.ngList||",";e.$parsers.push(function(a){if(!F(a)){var c=[];return a&&r(a.split(f),function(a){a&&c.push($(a))}),c}}),e.$formatters.push(function(a){return L(a)?a.join(", "):u}),e.$isEmpty=function(a){return!a||!a.length}}}},$e=/^(true|false|\d+)$/,Id=function(){return{priority:100,compile:function(a,c){return $e.test(c.ngValue)?function(a,c,f){f.$set("value",a.$eval(f.ngValue))}:function(a,c,f){a.$watch(f.ngValue,function(a){f.$set("value",a)})}}}},id=Aa({compile:function(a){return a.addClass("ng-binding"),function(a,d,e){d.data("$binding",e.ngBind),a.$watch(e.ngBind,function(a){d.text(a==u?"":a)})}}}),kd=["$interpolate",function(a){return function(c,d,e){c=a(d.attr(e.$attr.ngBindTemplate)),d.addClass("ng-binding").data("$binding",c),e.$observe("ngBindTemplate",function(a){d.text(a)})}}],jd=["$sce","$parse",function(a,c){return{compile:function(d){return d.addClass("ng-binding"),function(d,f,g){f.data("$binding",g.ngBindHtml);var h=c(g.ngBindHtml);d.$watch(function(){return(h(d)||"").toString()},function(){f.html(a.getTrustedHtml(h(d))||"")})}}}}],ld=Wb("",!0),nd=Wb("Odd",0),md=Wb("Even",1),od=Aa({compile:function(a,c){c.$set("ngCloak",u),a.removeClass("ng-cloak")}}),pd=[function(){return{scope:!0,controller:"@",priority:500}}],jc={},af={blur:!0,focus:!0};r("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),function(a){var c=qa("ng-"+a);jc[c]=["$parse","$rootScope",function(d,e){return{compile:function(f,g){var h=d(g[c],!0);return function(c,d){d.on(a,function(d){var f=function(){h(c,{$event:d})};af[a]&&e.$$phase?c.$evalAsync(f):c.$apply(f)})}}}}]});var sd=["$animate",function(a){return{transclude:"element",priority:600,terminal:!0,restrict:"A",$$tlb:!0,link:function(c,d,e,f,g){var h,k,m;c.$watch(e.ngIf,function(f){Wa(f)?k||(k=c.$new(),g(k,function(c){c[c.length++]=X.createComment(" end ngIf: "+e.ngIf+" "),h={clone:c},a.enter(c,d.parent(),d)})):(m&&(m.remove(),m=null),k&&(k.$destroy(),k=null),h&&(m=Eb(h.clone),a.leave(m,function(){m=null}),h=null))})}}}],td=["$http","$templateCache","$anchorScroll","$animate","$sce",function(a,c,d,e,f){return{restrict:"ECA",priority:400,terminal:!0,transclude:"element",controller:Xa.noop,compile:function(g,h){var k=h.ngInclude||h.src,m=h.onload||"",l=h.autoscroll;return function(g,h,p,r,J){var t,y,u,w=0,B=function(){y&&(y.remove(),y=null),t&&(t.$destroy(),t=null),u&&(e.leave(u,function(){y=null}),y=u,u=null)};g.$watch(f.parseAsResourceUrl(k),function(f){var k=function(){!D(l)||l&&!g.$eval(l)||d()},p=++w;f?(a.get(f,{cache:c}).success(function(a){if(p===w){var c=g.$new();r.template=a,a=J(c,function(a){B(),e.enter(a,null,h,k)}),t=c,u=a,t.$emit("$includeContentLoaded"),g.$eval(m)}}).error(function(){p===w&&B()}),g.$emit("$includeContentRequested")):(B(),r.template=null)})}}}}],Jd=["$compile",function(a){return{restrict:"ECA",priority:-400,require:"ngInclude",link:function(c,d,e,f){d.html(f.template),a(d.contents())(c)}}}],ud=Aa({priority:450,compile:function(){return{pre:function(a,c,d){a.$eval(d.ngInit)}}}}),vd=Aa({terminal:!0,priority:1e3}),wd=["$locale","$interpolate",function(a,c){var d=/{}/g;return{restrict:"EA",link:function(e,f,g){var h=g.count,k=g.$attr.when&&f.attr(g.$attr.when),m=g.offset||0,l=e.$eval(k)||{},n={},q=c.startSymbol(),p=c.endSymbol(),s=/^when(Minus)?(.+)$/;r(g,function(a,c){s.test(c)&&(l[x(c.replace("when","").replace("Minus","-"))]=f.attr(g.$attr[c]))}),r(l,function(a,e){n[e]=c(a.replace(d,q+h+"-"+m+p))}),e.$watch(function(){var c=parseFloat(e.$eval(h));return isNaN(c)?"":(c in l||(c=a.pluralCat(c-m)),n[c](e,f,!0))},function(a){f.text(a)})}}}],xd=["$parse","$animate",function(a,c){var d=z("ngRepeat");return{transclude:"element",priority:1e3,terminal:!0,$$tlb:!0,link:function(e,f,g,h,k){var n,q,p,s,u,w,m=g.ngRepeat,l=m.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/),t={$id:Na};if(!l)throw d("iexp",m);if(g=l[1],h=l[2],(l=l[3])?(n=a(l),q=function(a,c,d){return w&&(t[w]=a),t[u]=c,t.$index=d,n(e,t)}):(p=function(a,c){return Na(c)},s=function(a){return a}),l=g.match(/^(?:([\$\w]+)|\(([\$\w]+)\s*,\s*([\$\w]+)\))$/),!l)throw d("iidexp",g);u=l[3]||l[1],w=l[2];var y={};e.$watchCollection(h,function(a){var g,h,n,D,C,I,x,G,v,z,l=f[0],t={},F=[];if(Sa(a))v=a,G=q||p;else{G=q||s,v=[];for(I in a)a.hasOwnProperty(I)&&"$"!=I.charAt(0)&&v.push(I);v.sort()}for(D=v.length,h=F.length=v.length,g=0;h>g;g++)if(I=a===v?g:v[g],x=a[I],n=G(I,x,g),Ea(n,"`track by` id"),y.hasOwnProperty(n))z=y[n],delete y[n],t[n]=z,F[g]=z;else{if(t.hasOwnProperty(n))throw r(F,function(a){a&&a.scope&&(y[a.id]=a)}),d("dupes",m,n,oa(x));F[g]={id:n},t[n]=!1}for(I in y)y.hasOwnProperty(I)&&(z=y[I],g=Eb(z.clone),c.leave(g),r(g,function(a){a.$$NG_REMOVED=!0}),z.scope.$destroy());for(g=0,h=v.length;h>g;g++){if(I=a===v?g:v[g],x=a[I],z=F[g],F[g-1]&&(l=F[g-1].clone[F[g-1].clone.length-1]),z.scope){C=z.scope,n=l;do n=n.nextSibling;while(n&&n.$$NG_REMOVED);z.clone[0]!=n&&c.move(Eb(z.clone),null,A(l)),l=z.clone[z.clone.length-1]}else C=e.$new();C[u]=x,w&&(C[w]=I),C.$index=g,C.$first=0===g,C.$last=g===D-1,C.$middle=!(C.$first||C.$last),C.$odd=!(C.$even=0===(1&g)),z.scope||k(C,function(a){a[a.length++]=X.createComment(" end ngRepeat: "+m+" "),c.enter(a,null,A(l)),l=a,z.scope=C,z.clone=a,t[z.id]=z})}y=t})}}}],yd=["$animate",function(a){return function(c,d,e){c.$watch(e.ngShow,function(c){a[Wa(c)?"removeClass":"addClass"](d,"ng-hide")})}}],rd=["$animate",function(a){return function(c,d,e){c.$watch(e.ngHide,function(c){a[Wa(c)?"addClass":"removeClass"](d,"ng-hide")})}}],zd=Aa(function(a,c,d){a.$watch(d.ngStyle,function(a,d){d&&a!==d&&r(d,function(a,d){c.css(d,"")}),a&&c.css(a)},!0)}),Ad=["$animate",function(a){return{restrict:"EA",require:"ngSwitch",controller:["$scope",function(){this.cases={}}],link:function(c,d,e,f){var g=[],h=[],k=[],m=[];c.$watch(e.ngSwitch||e.on,function(d){var n,q;for(n=0,q=k.length;q>n;++n)k[n].remove();for(n=k.length=0,q=m.length;q>n;++n){var p=h[n];m[n].$destroy(),k[n]=p,a.leave(p,function(){k.splice(n,1)})}h.length=0,m.length=0,(g=f.cases["!"+d]||f.cases["?"])&&(c.$eval(e.change),r(g,function(d){var e=c.$new();m.push(e),d.transclude(e,function(c){var e=d.element;h.push(c),a.enter(c,e.parent(),e)})}))})}}}],Bd=Aa({transclude:"element",priority:800,require:"^ngSwitch",link:function(a,c,d,e,f){e.cases["!"+d.ngSwitchWhen]=e.cases["!"+d.ngSwitchWhen]||[],e.cases["!"+d.ngSwitchWhen].push({transclude:f,element:c})}}),Cd=Aa({transclude:"element",priority:800,require:"^ngSwitch",link:function(a,c,d,e,f){e.cases["?"]=e.cases["?"]||[],e.cases["?"].push({transclude:f,element:c})}}),Ed=Aa({link:function(a,c,d,e,f){if(!f)throw z("ngTransclude")("orphan",ia(c));f(function(a){c.empty(),c.append(a)})}}),ed=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(c,d){"text/ng-template"==d.type&&a.put(d.id,c[0].text)}}}],bf=z("ngOptions"),Dd=aa({terminal:!0}),fd=["$compile","$parse",function(a,c){var d=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,e={$setViewValue:v};return{restrict:"E",require:["select","?ngModel"],controller:["$element","$scope","$attrs",function(a,c,d){var n,k=this,m={},l=e;k.databound=d.ngModel,k.init=function(a,c,d){l=a,n=d},k.addOption=function(c){Ea(c,'"option value"'),m[c]=!0,l.$viewValue==c&&(a.val(c),n.parent()&&n.remove())},k.removeOption=function(a){this.hasOption(a)&&(delete m[a],l.$viewValue==a&&this.renderUnknownOption(a))},k.renderUnknownOption=function(c){c="? "+Na(c)+" ?",n.val(c),a.prepend(n),a.val(c),n.prop("selected",!0)},k.hasOption=function(a){return m.hasOwnProperty(a)},c.$on("$destroy",function(){k.renderUnknownOption=v})}],link:function(e,g,h,k){function m(a,c,d,e){d.$render=function(){var a=d.$viewValue;e.hasOption(a)?(x.parent()&&x.remove(),c.val(a),""===a&&w.prop("selected",!0)):F(a)&&w?c.val(""):e.renderUnknownOption(a)},c.on("change",function(){a.$apply(function(){x.parent()&&x.remove(),d.$setViewValue(c.val())})})}function l(a,c,d){var e;d.$render=function(){var a=new db(d.$viewValue);r(c.find("option"),function(c){c.selected=D(a.get(c.value))})},a.$watch(function(){Ca(e,d.$viewValue)||(e=ha(d.$viewValue),d.$render())}),c.on("change",function(){a.$apply(function(){var a=[];r(c.find("option"),function(c){c.selected&&a.push(c.value)}),d.$setViewValue(a)})})}function n(e,f,g){function h(){var d,k,s,u,v,a={"":[]},c=[""];s=g.$modelValue,u=A(e)||[];var G,Q,C,F=n?Xb(u):u;if(Q={},C=!1,p)if(k=g.$modelValue,w&&L(k))for(C=new db([]),d={},v=0;v<k.length;v++)d[m]=k[v],C.put(w(e,d),k[v]);else C=new db(k);v=C;var E,K;for(C=0;G=F.length,G>C;C++){if(k=C,n){if(k=F[C],"$"===k.charAt(0))continue;Q[n]=k}Q[m]=u[k],d=r(e,Q)||"",(k=a[d])||(k=a[d]=[],c.push(d)),p?d=D(v.remove(w?w(e,Q):x(e,Q))):(w?(d={},d[m]=s,d=w(e,d)===w(e,Q)):d=s===x(e,Q),v=v||d),E=l(e,Q),E=D(E)?E:"",k.push({id:w?w(e,Q):n?F[C]:C,label:E,selected:d})}for(p||(z||null===s?a[""].unshift({id:"",label:"",selected:!v}):v||a[""].unshift({id:"?",label:"",selected:!0})),Q=0,F=c.length;F>Q;Q++){for(d=c[Q],k=a[d],B.length<=Q?(s={element:y.clone().attr("label",d),label:k.label},u=[s],B.push(u),f.append(s.element)):(u=B[Q],s=u[0],s.label!=d&&s.element.attr("label",s.label=d)),E=null,C=0,G=k.length;G>C;C++)d=k[C],(v=u[C+1])?(E=v.element,v.label!==d.label&&(E.text(v.label=d.label),E.prop("label",v.label)),v.id!==d.id&&E.val(v.id=d.id),E[0].selected!==d.selected&&(E.prop("selected",v.selected=d.selected),R&&E.prop("selected",v.selected))):(""===d.id&&z?K=z:(K=t.clone()).val(d.id).prop("selected",d.selected).attr("selected",d.selected).prop("label",d.label).text(d.label),u.push({element:K,label:d.label,id:d.id,selected:d.selected}),q.addOption(d.label,K),E?E.after(K):s.element.append(K),E=K);for(C++;u.length>C;)d=u.pop(),q.removeOption(d.label),d.element.remove()}for(;B.length>Q;)B.pop()[0].element.remove()}var k;if(!(k=s.match(d)))throw bf("iexp",s,ia(f));var l=c(k[2]||k[1]),m=k[4]||k[6],n=k[5],r=c(k[3]||""),x=c(k[2]?k[1]:m),A=c(k[7]),w=k[8]?c(k[8]):null,B=[[{element:f,label:""}]];z&&(a(z)(e),z.removeClass("ng-scope"),z.remove()),f.empty(),f.on("change",function(){e.$apply(function(){var a,k,l,q,r,s,t,v,c=A(e)||[],d={};if(p){for(l=[],r=0,t=B.length;t>r;r++)for(a=B[r],q=1,s=a.length;s>q;q++)if((k=a[q].element)[0].selected){if(k=k.val(),n&&(d[n]=k),w)for(v=0;v<c.length&&(d[m]=c[v],w(e,d)!=k);v++);else d[m]=c[k];l.push(x(e,d))}}else if(k=f.val(),"?"==k)l=u;else if(""===k)l=null;else if(w){for(v=0;v<c.length;v++)if(d[m]=c[v],w(e,d)==k){l=x(e,d);break}}else d[m]=c[k],n&&(d[n]=k),l=x(e,d);g.$setViewValue(l),h()})}),g.$render=h,e.$watchCollection(A,h),e.$watchCollection(function(){var a={},c=A(e);if(c){for(var d=Array(c.length),f=0,g=c.length;g>f;f++)a[m]=c[f],d[f]=l(e,a);return d}},h),p&&e.$watchCollection(function(){return g.$modelValue},h)}if(k[1]){var q=k[0];k=k[1];var w,p=h.multiple,s=h.ngOptions,z=!1,t=A(X.createElement("option")),y=A(X.createElement("optgroup")),x=t.clone();h=0;for(var B=g.children(),v=B.length;v>h;h++)if(""===B[h].value){w=z=B.eq(h);break}q.init(k,z,x),p&&(k.$isEmpty=function(a){return!a||0===a.length}),s?n(e,g,k):p?l(e,g,k):m(e,g,k,q)}}}}],hd=["$interpolate",function(a){var c={addOption:v,removeOption:v};return{restrict:"E",priority:100,compile:function(d,e){if(F(e.value)){var f=a(d.text(),!0);f||e.$set("value",d.text())}return function(a,d,e){var m=d.parent(),l=m.data("$selectController")||m.parent().data("$selectController");l&&l.databound?d.prop("selected",!1):l=c,f?a.$watch(f,function(a,c){e.$set("value",a),a!==c&&l.removeOption(c),l.addOption(a)}):l.addOption(e.value),d.on("$destroy",function(){l.removeOption(e.value)})}}}}],gd=aa({restrict:"E",terminal:!0});W.angular.bootstrap?console.log("WARNING: Tried to load angular more than once."):((Fa=W.jQuery)&&Fa.fn.on?(A=Fa,E(Fa.fn,{scope:Oa.scope,isolateScope:Oa.isolateScope,controller:Oa.controller,injector:Oa.injector,inheritedData:Oa.inheritedData}),Gb("remove",!0,!0,!1),Gb("empty",!1,!1,!1),Gb("html",!1,!1,!0)):A=S,Xa.element=A,Zc(Xa),A(X).ready(function(){Wc(X,dc)}))}(window,document),!window.angular.$$csp()&&window.angular.element(document).find("head").prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}.ng-animate-block-transitions{transition:0s all!important;-webkit-transition:0s all!important;}.ng-hide-add-active,.ng-hide-remove{display:block!important;}</style>'),function(n,e){"use strict";function x(s,g,h){return{restrict:"ECA",terminal:!0,priority:400,transclude:"element",link:function(a,c,b,f,w){function y(){p&&(p.remove(),p=null),k&&(k.$destroy(),k=null),l&&(h.leave(l,function(){p=null}),p=l,l=null)}function v(){var b=s.current&&s.current.locals;if(e.isDefined(b&&b.$template)){var b=a.$new(),d=s.current;l=w(b,function(d){h.enter(d,null,l||c,function(){!e.isDefined(t)||t&&!a.$eval(t)||g()}),y()}),k=d.scope=b,k.$emit("$viewContentLoaded"),k.$eval(u)}else y()}var k,l,p,t=b.autoscroll,u=b.onload||"";a.$on("$routeChangeSuccess",v),v()}}}function z(e,g,h){return{restrict:"ECA",priority:-400,link:function(a,c){var b=h.current,f=b.locals;c.html(f.$template);var w=e(c.contents());b.controller&&(f.$scope=a,f=g(b.controller,f),b.controllerAs&&(a[b.controllerAs]=f),c.data("$ngControllerController",f),c.children().data("$ngControllerController",f)),w(a)}}}n=e.module("ngRoute",["ng"]).provider("$route",function(){function s(a,c){return e.extend(new(e.extend(function(){},{prototype:a})),c)}function g(a,e){var b=e.caseInsensitiveMatch,f={originalPath:a,regexp:a},h=f.keys=[];return a=a.replace(/([().])/g,"\\$1").replace(/(\/)?:(\w+)([\?\*])?/g,function(a,e,b,c){return a="?"===c?c:null,c="*"===c?c:null,h.push({name:b,optional:!!a}),e=e||"",""+(a?"":e)+"(?:"+(a?e:"")+(c&&"(.+?)"||"([^/]+)")+(a||"")+")"+(a||"")}).replace(/([\/$\*])/g,"\\$1"),f.regexp=RegExp("^"+a+"$",b?"i":""),f}var h={};this.when=function(a,c){if(h[a]=e.extend({reloadOnSearch:!0},c,a&&g(a,c)),a){var b="/"==a[a.length-1]?a.substr(0,a.length-1):a+"/";h[b]=e.extend({redirectTo:a},g(b,c))}return this},this.otherwise=function(a){return this.when(null,a),this},this.$get=["$rootScope","$location","$routeParams","$q","$injector","$http","$templateCache","$sce",function(a,c,b,f,g,n,v,k){function l(){var d=p(),m=r.current;d&&m&&d.$$route===m.$$route&&e.equals(d.pathParams,m.pathParams)&&!d.reloadOnSearch&&!u?(m.params=d.params,e.copy(m.params,b),a.$broadcast("$routeUpdate",m)):(d||m)&&(u=!1,a.$broadcast("$routeChangeStart",d,m),(r.current=d)&&d.redirectTo&&(e.isString(d.redirectTo)?c.path(t(d.redirectTo,d.params)).search(d.params).replace():c.url(d.redirectTo(d.pathParams,c.path(),c.search())).replace()),f.when(d).then(function(){if(d){var c,b,a=e.extend({},d.resolve);return e.forEach(a,function(d,c){a[c]=e.isString(d)?g.get(d):g.invoke(d)}),e.isDefined(c=d.template)?e.isFunction(c)&&(c=c(d.params)):e.isDefined(b=d.templateUrl)&&(e.isFunction(b)&&(b=b(d.params)),b=k.getTrustedResourceUrl(b),e.isDefined(b)&&(d.loadedTemplateUrl=b,c=n.get(b,{cache:v}).then(function(a){return a.data}))),e.isDefined(c)&&(a.$template=c),f.all(a)}}).then(function(c){d==r.current&&(d&&(d.locals=c,e.copy(d.params,b)),a.$broadcast("$routeChangeSuccess",d,m))},function(c){d==r.current&&a.$broadcast("$routeChangeError",d,m,c)}))}function p(){var a,b;return e.forEach(h,function(f){var q;if(q=!b){var g=c.path();q=f.keys;var l={};if(f.regexp)if(g=f.regexp.exec(g)){for(var k=1,p=g.length;p>k;++k){var n=q[k-1],r=g[k];n&&r&&(l[n.name]=r)}q=l}else q=null;else q=null;q=a=q}q&&(b=s(f,{params:e.extend({},c.search(),a),pathParams:a}),b.$$route=f)}),b||h[null]&&s(h[null],{params:{},pathParams:{}})}function t(a,c){var b=[];return e.forEach((a||"").split(":"),function(a,d){if(0===d)b.push(a);else{var e=a.match(/(\w+)(?:[?*])?(.*)/),f=e[1];b.push(c[f]),b.push(e[2]||""),delete c[f]}}),b.join("")}var u=!1,r={routes:h,reload:function(){u=!0,a.$evalAsync(l)}};return a.$on("$locationChangeSuccess",l),r}]}),n.provider("$routeParams",function(){this.$get=function(){return{}}}),n.directive("ngView",x),n.directive("ngView",z),x.$inject=["$route","$anchorScroll","$animate"],z.$inject=["$compile","$controller","$route"]}(window,window.angular),function(p,f,n){"use strict";f.module("ngCookies",["ng"]).factory("$cookies",["$rootScope","$browser",function(e,b){var h,c={},g={},k=!1,l=f.copy,m=f.isUndefined;return b.addPollFn(function(){var a=b.cookies();h!=a&&(h=a,l(a,g),l(a,c),k&&e.$apply())})(),k=!0,e.$watch(function(){var a,d,e;for(a in g)m(c[a])&&b.cookies(a,n);for(a in c)d=c[a],f.isString(d)||(d=""+d,c[a]=d),d!==g[a]&&(b.cookies(a,d),e=!0);if(e)for(a in d=b.cookies(),c)c[a]!==d[a]&&(m(d[a])?delete c[a]:c[a]=d[a])}),c}]).factory("$cookieStore",["$cookies",function(e){return{get:function(b){return(b=e[b])?f.fromJson(b):b},put:function(b,c){e[b]=f.toJson(c)},remove:function(b){delete e[b]}}}])}(window,window.angular),function(q,g,r){"use strict";function F(a){var d=[];return t(d,g.noop).chars(a),d.join("")}function l(a){var d={};a=a.split(",");var c;for(c=0;c<a.length;c++)d[a[c]]=!0;return d}function G(a,d){function c(a,b,c,h){if(b=g.lowercase(b),u[b])for(;f.last()&&v[f.last()];)e("",f.last());w[b]&&f.last()==b&&e("",b),(h=x[b]||!!h)||f.push(b);var n={};c.replace(H,function(a,b,d,c,e){n[b]=s(d||c||e||"")}),d.start&&d.start(b,n,h)}function e(a,b){var e,c=0;if(b=g.lowercase(b))for(c=f.length-1;c>=0&&f[c]!=b;c--);if(c>=0){for(e=f.length-1;e>=c;e--)d.end&&d.end(f[e]);f.length=c}}"string"!=typeof a&&(a=null===a||"undefined"==typeof a?"":""+a);var b,k,h,f=[],n=a;for(f.last=function(){return f[f.length-1]};a;){if(h="",k=!0,f.last()&&y[f.last()]?(a=a.replace(RegExp("(.*)<\\s*\\/\\s*"+f.last()+"[^>]*>","i"),function(a,b){return b=b.replace(I,"$1").replace(J,"$1"),d.chars&&d.chars(s(b)),""}),e("",f.last())):(0===a.indexOf("<!--")?(b=a.indexOf("--",4),b>=0&&a.lastIndexOf("-->",b)===b&&(d.comment&&d.comment(a.substring(4,b)),a=a.substring(b+3),k=!1)):z.test(a)?(b=a.match(z))&&(a=a.replace(b[0],""),k=!1):K.test(a)?(b=a.match(A))&&(a=a.substring(b[0].length),b[0].replace(A,e),k=!1):L.test(a)&&((b=a.match(B))?(b[4]&&(a=a.substring(b[0].length),b[0].replace(B,c)),k=!1):(h+="<",a=a.substring(1))),k&&(b=a.indexOf("<"),h+=0>b?a:a.substring(0,b),a=0>b?"":a.substring(b),d.chars&&d.chars(s(h)))),a==n)throw M("badparse",a);n=a}e()}function s(a){if(!a)return"";var d=N.exec(a);a=d[1];var c=d[3];return(d=d[2])&&(p.innerHTML=d.replace(/</g,"&lt;"),d="textContent"in p?p.textContent:p.innerText),a+d+c}function C(a){return a.replace(/&/g,"&amp;").replace(O,function(a){var c=a.charCodeAt(0);return a=a.charCodeAt(1),"&#"+(1024*(c-55296)+(a-56320)+65536)+";"}).replace(P,function(a){return"&#"+a.charCodeAt(0)+";"}).replace(/</g,"&lt;").replace(/>/g,"&gt;")}function t(a,d){var c=!1,e=g.bind(a,a.push);return{start:function(a,k,f){a=g.lowercase(a),!c&&y[a]&&(c=a),c||!0!==D[a]||(e("<"),e(a),g.forEach(k,function(c,f){var m=g.lowercase(f),k="img"===a&&"src"===m||"background"===m;!0!==Q[m]||!0===E[m]&&!d(c,k)||(e(" "),e(f),e('="'),e(C(c)),e('"'))}),e(f?"/>":">"))},end:function(a){a=g.lowercase(a),c||!0!==D[a]||(e("</"),e(a),e(">")),a==c&&(c=!1)},chars:function(a){c||e(C(a))}}}var M=g.$$minErr("$sanitize"),B=/^<((?:[a-zA-Z])[\w:-]*)((?:\s+[\w:-]+(?:\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|[^>\s]+))?)*)\s*(\/?)\s*(>?)/,A=/^<\/\s*([\w:-]+)[^>]*>/,H=/([\w:-]+)(?:\s*=\s*(?:(?:"((?:[^"])*)")|(?:'((?:[^'])*)')|([^>\s]+)))?/g,L=/^</,K=/^<\//,I=/\x3c!--(.*?)--\x3e/g,z=/<!DOCTYPE([^>]*?)>/i,J=/<!\[CDATA\[(.*?)]]\x3e/g,O=/[\uD800-\uDBFF][\uDC00-\uDFFF]/g,P=/([^\#-~| |!])/g,x=l("area,br,col,hr,img,wbr");q=l("colgroup,dd,dt,li,p,tbody,td,tfoot,th,thead,tr"),r=l("rp,rt");var w=g.extend({},r,q),u=g.extend({},q,l("address,article,aside,blockquote,caption,center,del,dir,div,dl,figure,figcaption,footer,h1,h2,h3,h4,h5,h6,header,hgroup,hr,ins,map,menu,nav,ol,pre,script,section,table,ul")),v=g.extend({},r,l("a,abbr,acronym,b,bdi,bdo,big,br,cite,code,del,dfn,em,font,i,img,ins,kbd,label,map,mark,q,ruby,rp,rt,s,samp,small,span,strike,strong,sub,sup,time,tt,u,var")),y=l("script,style"),D=g.extend({},x,u,v,w),E=l("background,cite,href,longdesc,src,usemap"),Q=g.extend({},E,l("abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,color,cols,colspan,compact,coords,dir,face,headers,height,hreflang,hspace,ismap,lang,language,nohref,nowrap,rel,rev,rows,rowspan,rules,scope,scrolling,shape,size,span,start,summary,target,title,type,valign,value,vspace,width")),p=document.createElement("pre"),N=/^(\s*)([\s\S]*?)(\s*)$/;g.module("ngSanitize",[]).provider("$sanitize",function(){this.$get=["$$sanitizeUri",function(a){return function(d){var c=[];return G(d,t(c,function(c,b){return!/^unsafe/.test(a(c,b))})),c.join("")}}]}),g.module("ngSanitize").filter("linky",["$sanitize",function(a){var d=/((ftp|https?):\/\/|(mailto:)?[A-Za-z0-9._%+-]+@)\S*[^\s.;,(){}<>"]/,c=/^mailto:/;return function(e,b){function k(a){a&&m.push(F(a))}function f(a,c){m.push("<a "),g.isDefined(b)&&(m.push('target="'),m.push(b),m.push('" ')),m.push('href="',a.replace('"',"&quot;"),'">'),k(c),m.push("</a>")}if(!e)return e;for(var n,l,p,h=e,m=[];n=h.match(d);)l=n[0],n[2]==n[3]&&(l="mailto:"+l),p=n.index,k(h.substr(0,p)),f(l,n[0].replace(c,"")),h=h.substring(p+n[0].length);return k(h),a(m.join(""))}}])}(window,window.angular);var app=angular.module("asterion",["ngRoute","ngCookies","ngSanitize","global","drawer","selection","dashboard","search","detail","carts","advanced","outside","isbn","tracing","standing","nts","approval","profile","help"]);app.config(["$routeProvider",function($routeProvider){$routeProvider.when("/",{templateUrl:"partials/dash/main",controller:"dashboardController"}).when("/search/:query",{templateUrl:"partials/search/results",controller:"searchController"}).when("/detail/:slug/:id",{templateUrl:"partials/detail/main",controller:"detailController"}).when("/cart/:slug/:id",{templateUrl:"partials/cart/main",controller:"cartController"}).when("/advanced-search",{templateUrl:"partials/advanced/main",controller:"advancedController"}).when("/order-outside-database",{templateUrl:"partials/outside/main",controller:"outsideController"}).when("/isbn-upload",{templateUrl:"partials/isbn/main",controller:"isbnController"}).when("/order-tracing",{templateUrl:"partials/tracing/main",controller:"tracingController"}).when("/standing-orders",{templateUrl:"partials/standing/main",controller:"standingController"}).when("/new-title-service",{templateUrl:"partials/nts/main",controller:"ntsController"}).when("/approval-plans",{templateUrl:"partials/approval/main",controller:"approvalController"}).when("/profile",{templateUrl:"partials/profile/main",controller:"profileController"}).when("/help",{templateUrl:"partials/help/main",controller:"helpController"}).otherwise({redirectTo:"/"})}]),app.filter("highlight",function(){return function(text,search,caseSensitive){if(!text)return!1;text=text.toString(),search=search.toString(),search=search.split(" ");for(i in search)if(text=text&&(search[i]||angular.isNumber(search[i]))?caseSensitive?text.split(search[i]).join("<mark>"+search[i]+"</mark>"):text.replace(new RegExp(search[i],"gi"),"<mark>$&</mark>"):text,i==search.length-1)return text}}),app.factory("focus",["$timeout",function($timeout){return function(id){$timeout(function(){var element=document.getElementById(id);element&&element.focus()})}}]),app.factory("searchify",function(){return function(text){return text.toString().replace(/\s+/g,"+").replace(/[^\w\+]+/g,"").replace(/\+\++/g,"+")}}),app.factory("slugify",function(){return function(text){return text.toString().toLowerCase().replace(/\s+/g,"-").replace(/[^\w\-]+/g,"").replace(/\-\-+/g,"-").replace(/^-+/,"").replace(/-+$/,"")}}),angular.element(document).ready(function(){var header=$("body > header").outerHeight(),subheader=$(".subheader").outerHeight(),top=($(".container > footer").outerHeight(),$(".container").scrollTop()),direction="down",marginTop=0;$(".container").scroll(function(){$(".container").scrollTop()>top?direction="down":$(".container").scrollTop()<top&&(direction="up"),top=$(".container").scrollTop();var container=$("#main").outerHeight(),aside=$(".sticky").outerHeight(),viewport=$(window).height()-header;subheader>top?marginTop=0:top>subheader&&(viewport>aside?marginTop=container-aside>top-subheader?top-subheader:container-aside:aside>=viewport&&("down"==direction?top-subheader>container-viewport?marginTop=marginTop:top-marginTop>aside-viewport+subheader&&top-subheader>aside-viewport&&(marginTop=top-subheader-(aside-viewport)):"up"==direction&&marginTop>top-subheader&&(marginTop=top-subheader))),$(".sticky").css("margin-top",marginTop)})});var ctrl=angular.module("global",[]);ctrl.controller("globalController",["$scope","$rootScope","$http","$location","$timeout","$cookieStore","focus","searchify","slugify",function($scope,$rootScope,$http,$location,$timeout,$cookieStore,focus,searchify,slugify){$rootScope.masthead="Asterion",$rootScope.titleSep1=" ‒ ",$rootScope.titleSep2=" « ",$rootScope.titleLine="Bookselling like a pro"+$rootScope.titleSep1+$rootScope.masthead,$rootScope.searchTerm,$scope.menuSearch=[{name:"Advanced search",slug:"advanced-search"},{name:"Outside database",slug:"order-outside-database"},{name:"ISBN upload",slug:"isbn-upload"}],$scope.menuOrders=[{name:"Order tracing",slug:"order-tracing"},{name:"Standing orders and journals",slug:"standing-orders"},{name:"New title service",slug:"new-title-service"},{name:"Approval plans",slug:"approval-plans"}],$scope.menuUser=[{name:"Profile",slug:"profile"},{name:"Language",sub:[{code:"en",name:"English"},{code:"de",name:"Deutsch"},{code:"fr",name:"Français"},{code:"nl",name:"Nederlands"},{code:"es",name:"Español"},{code:"it",name:"Italiano"}]},{name:"Help",slug:"help"}],$rootScope.fromNow=function(date){return moment(date).fromNow()},$scope.clickSearch=function(){focus("search")},$scope.quickSearch=function(searchTerm){searchTerm=searchify(searchTerm),$location.path("/search/"+searchTerm)},$scope.currentLang="en",$scope.changeLang=function(tongue){$scope.currentLang=tongue},$scope.menuEntered=!1,$scope.menuEnter=function($event,arg){40==$event.keyCode&&0==arg&&($scope.menuEntered=!0,$event.preventDefault(),focus("menu-0"))},$scope.menuNav=function($event,arg){if(40==$event.keyCode){$event.preventDefault();var i="menu-"+(arg+1);focus(i)}else if(38==$event.keyCode)if($event.preventDefault(),0==arg)$scope.menuEntered=!1,focus("menu-top");else{var i="menu-"+(arg-1);focus(i)}else 13==$event.keyCode&&($scope.menuEntered=!1,focus(""))},$rootScope.user={},$rootScope.getUser=function(){$http.post("/users/read").success(function(user){$rootScope.user=user,$rootScope.getActiveCart(user.cart)})},$rootScope.getUser(),$rootScope.cartsLoading=!1,$rootScope.cartList=[],$rootScope.getCarts=function(){$rootScope.cartsLoading=!0,$http.post("/carts/list").success(function(carts){$rootScope.cartList=carts,$rootScope.cartsLoading=!1,$rootScope.cartList.forEach(function(cart){cart.slug=slugify(cart.title)})})},$rootScope.getCarts(),$rootScope.loadingActiveCart=!1,$rootScope.activeCart={},$rootScope.getActiveCart=function(id){$rootScope.loadingActiveCart=!0,$http.post("/carts/detail",{id:id}).success(function(cart){$rootScope.activeCart=cart,$rootScope.loadingActiveCart=!1,$rootScope.activeCart.books.forEach(function(item){item.book.slug=slugify(item.book.title)})})},$rootScope.addingToCart=!1,$rootScope.addedToCart=!1,$rootScope.addToCart=function(book,cart){$rootScope.addingToCart=book,$http.post("/carts/add/single",{book:book,cart:cart}).success(function(){$rootScope.getActiveCart($rootScope.user.cart),$rootScope.getCarts(),$timeout(function(){$rootScope.addingToCart=!1,$rootScope.addedToCart=book,$timeout(function(){$rootScope.addedToCart=!1},3e3)},750)})},$scope.dropdownCarts=!1,$scope.cartsDropdown=function(arg){0==arg&&$timeout(function(){$scope.dropdownCarts=arg},250),0!=arg&&($scope.dropdownCarts=arg)},$rootScope.reloadEverything=function(){$rootScope.getCarts(),$rootScope.getActiveCart($rootScope.user.cart)},$rootScope.checkIfSelected=function(book){angular.forEach($rootScope.selectedTitles.books,function(obj){obj._id==book._id})}}]);var ctrl=angular.module("drawer",[]);ctrl.controller("drawerController",["$scope","$http","$rootScope","$location","focus","slugify",function($scope,$http,$rootScope,$location,focus,slugify){$scope.drawerMenu=[{name:"Contents",slug:"contents",url:"/partials/drawer/contents"},{name:"Shopping carts",slug:"carts",url:"/partials/drawer/carts"}],$rootScope.drawerPin=!1,$scope.drawerToggle=function(pin){$rootScope.drawerPin=pin?!1:!0,$rootScope.cartList.length<1&&focus("cart-name-empty")},$scope.drawerKeypress=function($event,pin){13==$event.keyCode&&$scope.drawerToggle(pin)},$scope.drawerActive=$scope.drawerMenu[0],$scope.gotoDrawer=function(option){$scope.drawerActive=option},$scope.createCartEmpty=function(){$http.post("/carts/create",{title:$scope.cartNameEmpty,slug:slugify($scope.cartNameEmpty)}).success(function(response){$scope.cartsName="",$scope.cartsNew=!1,$rootScope.getCarts(),$http.post("/users/cart",response).success(function(what){$rootScope.user.cart=what.id,$rootScope.getActiveCart(what.id)})})}}]),ctrl.controller("drawerCarts",["$scope","$rootScope","$http","focus","slugify","$location",function($scope,$rootScope,$http,focus,slugify){$scope.cartsSearch=!1,$scope.cartsSearchToggle=function(arg){$scope.cartsSearch=arg?!1:!0,0==arg&&focus("carts-query"),1==arg&&($scope.cartsQuery="")
},$scope.cartsNew=!1,$scope.cartsNewToggle=function(arg){$scope.cartsNew=arg?!1:!0,0==arg&&focus("carts-name"),1==arg&&($scope.cartsName="")},$scope.createCart=function(){$http.post("/carts/create",{title:$scope.cartsName,slug:slugify($scope.cartsName)}).success(function(){$scope.cartsName="",$scope.cartsNew=!1,$rootScope.getCarts()})},$scope.activateCart=function(cart){$http.post("/users/cart",cart).success(function(response){$rootScope.user.cart=response.id,$rootScope.getActiveCart(response.id)})},$scope.removeCart=function(cart){confirm("Are you sure you want to remove this cart?")&&($rootScope.cartList.splice($rootScope.cartList.indexOf(cart),1),cart._id==$rootScope.user.cart&&$rootScope.cartList.length>0&&$scope.activateCart($rootScope.cartList[0]),$http.post("/carts/remove",{id:cart._id}))},$scope.renameCart=function(cart){var i=$rootScope.cartList.indexOf(cart),title=prompt("Please enter new shopping cart name",$rootScope.cartList[i].title);null!=title&&($rootScope.cartList[i].title=title,$rootScope.cartList[i].slug=slugify(title),$http.post("/carts/rename",$rootScope.cartList[i]).success(function(){$rootScope.getCarts()}))}}]),ctrl.controller("drawerContents",["$scope","$rootScope","$http","$cookieStore","$timeout","slugify","$routeParams",function($scope,$rootScope,$http,$cookieStore,$timeout,slugify){$scope.removeCart=function(){confirm("Are you sure you want to remove this cart?")&&($rootScope.cartList.splice($rootScope.cartList.indexOf(cart),1),$rootScope.activeCart._id==$rootScope.user.cart&&$rootScope.cartList.length>0&&$rootScope.activateCart($rootScope.cartList[0]),$http.post("/carts/remove",{id:$rootScope.activeCart._id}),$rootScope.getCarts())},$scope.removingBook=!1,$scope.removeBook=function(result){$scope.removingBook=result._id,$timeout(function(){$rootScope.activeCart.books.splice($rootScope.activeCart.books.indexOf(result),1),$scope.updateCart()},295)},$scope.renameCart=function(){var title=prompt("Please enter new shopping cart name",$rootScope.activeCart.title);null!=title&&($rootScope.activeCart.title=title,$rootScope.activeCart.slug=slugify(title),$http.post("/carts/rename",$rootScope.activeCart).success(function(response){$rootScope.activeCart.quantity=response.quantity,$rootScope.activeCart.price=response.price,$rootScope.activeCart.editor=response.editor,$rootScope.activeCart.edited=response.edited,$rootScope.getCarts()}))};var timer=!1;$scope.updateCart=function(){timer&&$timeout.cancel(timer),timer=$timeout(function(){$http.post("/carts/update",$rootScope.activeCart).success(function(response){$rootScope.activeCart.quantity=response.quantity,$rootScope.activeCart.price=response.price,$rootScope.activeCart.editor=response.editor,$rootScope.activeCart.edited=response.edited,$rootScope.getCarts()})},500)},$scope.gotoDetail=function(index){$cookieStore.put("detailSource",{page:"cart",source:$rootScope.activeCart.title,id:$rootScope.activeCart._id,pos:index,total:$rootScope.activeCart.books.length})}}]);var ctrl=angular.module("selection",[]);ctrl.controller("selectionController",["$scope","$rootScope","$http","$cookieStore","$timeout",function($scope,$rootScope,$http,$cookieStore,$timeout){$scope.selectionCarts=!1,$scope.selectionCartsToggle=function(toggle){1==toggle&&($scope.selectionCarts=!0),0==toggle&&$timeout(function(){$scope.selectionCarts=!1},250)},$rootScope.selectUrl="/partials/selection/main",$rootScope.initSelection=function(){$rootScope.user.select={page:"",source:"",slug:"",id:"",books:[],selection:[]},$http.post("/users/selection",{selection:$rootScope.user.select})},$rootScope.selectTitle=function(book,page,source){if($rootScope.user.select.source!=source&&$rootScope.initSelection(),$rootScope.user.select.source=source,$rootScope.user.select.page=page,$rootScope.user.select.books.indexOf(book._id)<0)$rootScope.user.select.books.push(book._id),$rootScope.user.select.selection.push(book);else{$rootScope.user.select.books.splice($rootScope.user.select.books.indexOf(book._id),1);for(i in $rootScope.user.select.selection)$rootScope.user.select.selection[i]._id==book._id&&$rootScope.user.select.selection.splice(i,1)}$http.post("/users/selection",{selection:$rootScope.user.select})},$rootScope.addSelectionToCart=function(books,cart){$rootScope.addingSelectionToCart=!0,$http.post("/carts/add/multiple",{books:books,cart:cart}).success(function(){$rootScope.getActiveCart($rootScope.user.cart),$rootScope.getCarts(),$timeout(function(){$rootScope.addingSelectionToCart=!1,$rootScope.addedSelectionToCart=!0,$timeout(function(){$rootScope.addedSelectionToCart=!1,$rootScope.initSelection()},2e3)},1250)})}}]);var ctrl=angular.module("carts",[]);ctrl.controller("cartController",["$scope","$rootScope","$http","$location","$routeParams","$cookieStore","$timeout","slugify","focus",function($scope,$rootScope,$http,$location,$routeParams,$cookieStore,$timeout,slugify,focus){$rootScope.pageSlug="cart",$rootScope.pageTitle="Shopping cart",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead,$scope.cartLoading=!0,$scope.cart={},$scope.getCart=function(id){$scope.cartLoading=!0,$http.post("/carts/detail",{id:id}).success(function(cart){$scope.cart=cart,$scope.cartLoading=!1,$scope.cart.books.forEach(function(item){item.book.slug=slugify(item.book.title)}),$rootScope.pageSubtitle=cart.title,$rootScope.titleLine=$rootScope.pageSubtitle+$rootScope.titleSep1+$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead})},$scope.getCart($routeParams.id),$scope.gotoDetail=function(index){$cookieStore.put("detailSource",{page:"cart",source:$scope.cart.title,id:$scope.cart._id,pos:index,total:$scope.cart.books.length})};var timer=!1;$scope.updateCart=function(){timer&&$timeout.cancel(timer),timer=$timeout(function(){$http.post("/carts/update",$scope.cart).success(function(response){$scope.cart.quantity=response.quantity,$scope.cart.price=response.price,$scope.cart.editor=response.editor,$scope.cart.edited=response.edited,response._id==$rootScope.activeCart._id&&$rootScope.getActiveCart(response._id),$rootScope.getCarts()})},500)},$rootScope.removingBook=[],$rootScope.removeBook=function(result){$rootScope.removingBook.push(result._id),$timeout(function(){$scope.cart.books.splice($scope.cart.books.indexOf(result),1),$rootScope.user.select.books.indexOf(result.book._id)>-1&&$rootScope.selectTitle(result.book,"cart",$scope.cart._id),$scope.updateCart(),$rootScope.removingBook.splice($rootScope.removingBook.indexOf(result._id),1)},295)},$rootScope.removeSelectionFromCart=function(books){var spartans=[];for(i in $scope.cart.books)books.indexOf($scope.cart.books[i].book._id)>-1&&($rootScope.removingBook.push($scope.cart.books[i]._id),spartans.push($scope.cart.books[i])),i==$scope.cart.books.length-1&&$timeout(function(){for(j in spartans)$scope.cart.books.splice($scope.cart.books.indexOf(spartans[j]),1);$scope.updateCart(),$rootScope.initSelection(),$rootScope.removingBook=[]},295)},$scope.activateCart=function(){$http.post("/users/cart",$scope.cart).success(function(response){$rootScope.user.cart=response.id,$rootScope.getActiveCart(response.id)})},$scope.renameCart=function(){var title=prompt("Please enter new shopping cart name",$scope.cart.title);null!=title&&($scope.cart.title=title,$scope.cart.slug=slugify(title),$scope.updateCart(),$rootScope.pageSubtitle=title,$rootScope.titleLine=$rootScope.pageSubtitle+$rootScope.titleSep1+$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead)},$scope.removeCart=function(){confirm("Are you sure you want to remove this cart?")&&($rootScope.cartList.splice($rootScope.cartList.indexOf($scope.cart),1),$scope.cart._id==$rootScope.user.cart&&$rootScope.cartList.length>0&&$scope.activateCart($rootScope.cartList[0]),$http.post("/carts/remove",{id:$scope.cart._id}).success(function(){$location.path("/")}))},$scope.editingRef=!1,$scope.editRef=function(id,type){$scope.editingRef={ref:type,id:id},focus(type+"-"+id)},$scope.editingRefBlur=function(){$scope.editingRef=!1},$scope.editingRefKeypress=function($event){13==$event.keyCode&&($scope.editingRef=!1)},$scope.activeAllRefs=!1,$scope.activateAllRef=function(arg){$scope.activeAllRefs=arg,focus("allref-"+arg)},$scope.allRefs,$scope.initAllRefs=function(){$scope.allRefs={reference:"",department:"",budget:"",instructions:""}},$scope.initAllRefs(),$scope.blurAllRefs=function(){$scope.activeAllRefs=!1},$scope.applyAllRefs=function(){for(i in $scope.cart.books)$scope.allRefs.reference.length>0&&($scope.cart.books[i].reference=$scope.allRefs.reference),$scope.allRefs.department.length>0&&($scope.cart.books[i].department=$scope.allRefs.department),$scope.allRefs.budget.length>0&&($scope.cart.books[i].budget=$scope.allRefs.budget),$scope.allRefs.instructions.length>0&&($scope.cart.books[i].instructions=$scope.allRefs.instructions);$scope.updateCart()},$scope.removeAllRefs=function(){if(confirm("Are you sure you want to remove all references from all titles in this cart?")){for(i in $scope.cart.books)$scope.cart.books[i].reference="",$scope.cart.books[i].department="",$scope.cart.books[i].budget="",$scope.cart.books[i].instructions="";$scope.updateCart()}},$scope.selectCart=function(){for(i in $scope.cart.books)$rootScope.user.select.books.indexOf($scope.cart.books[i].book._id)<0&&$rootScope.selectTitle($scope.cart.books[i].book,"cart",$scope.cart._id)},$scope.orderingCart=!1,$scope.orderedCart=!1,$scope.orderCart=function(){$scope.orderingCart=!0,$timeout(function(){$scope.orderingCart=!1,$scope.orderedCart=!0,$timeout(function(){$scope.orderedCart=!1,$location.path("/")},2e3)},1e3)},$scope.quotingCart=!1,$scope.quotedCart=!1,$scope.quoteCart=function(){$scope.quotingCart=!0,$timeout(function(){$scope.quotingCart=!1,$scope.quotedCart=!0,$timeout(function(){$scope.quotedCart=!1},2e3)},1e3)}}]);var ctrl=angular.module("dashboard",[]);ctrl.controller("dashboardController",["$scope","$rootScope","$http","$location",function($scope,$rootScope){$rootScope.pageSlug="dashboard",$rootScope.pageTitle="Dashboard",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);var ctrl=angular.module("search",[]);ctrl.controller("searchController",["$scope","$rootScope","$http","$location","$routeParams","$cookieStore","slugify",function($scope,$rootScope,$http,$location,$routeParams,$cookieStore,slugify){$rootScope.pageSlug="search",$rootScope.pageTitle="Search",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead,$scope.searchLoading=!0,$scope.noResults=!1,$scope.searchedFor="",$scope.sortMethods=[{slug:"relevance",name:"Relevance"},{slug:"title",name:"Title"},{slug:"author",name:"Author"},{slug:"publisher",name:"Publisher"},{slug:"isbn",name:"ISBN"}],$scope.pagination={page:0,limit:12,pages:0};var sortNo=$cookieStore.get("currentSortMethod")||0;$scope.currentSortMethod=$scope.sortMethods[sortNo],$scope.sortOrder=$cookieStore.get("sortOrder")||"asc",$scope.filterState=$cookieStore.get("filterState")||{status:"open",group:"close",country:"close"},$scope.filter={group:[],status:[],country:[],order:[]},$scope.filterDisplay=function(filter){$scope.filterState[filter]="open"==$scope.filterState[filter]?"close":"open",$cookieStore.put("filterState",$scope.filterState)},$scope.filterToggle=function(section,arg){if(arg){var i=$scope.filter[section].indexOf(arg);0>i?$scope.filter[section].push(arg):$scope.filter[section].splice(i,1)}else $scope.filter[section].length=0;$scope.searchLoading=!0,$scope.pagination.page=0,$scope.getResults($scope.searchedFor)},$scope.getResults=function(searchTerm){if(!searchTerm){if(!$routeParams.query)return $location.path("/");searchTerm=$routeParams.query.replace(/\+/g," "),$rootScope.searchTerm=searchTerm}$scope.noResults=!1,$scope.searchedFor=searchTerm,$http.post("/search/results",{search:searchTerm,page:$scope.pagination.page,limit:$scope.pagination.limit,sort:$scope.currentSortMethod.slug,order:$scope.sortOrder,filter:$scope.filter}).success(function(response){$scope.searchLoading=!1,response.hits.total<1&&($scope.noResults=!0),$scope.results=response.hits.hits,$scope.total=response.hits.total,$scope.aggs=response.aggregations,$scope.pagination.pages=Math.ceil(response.hits.total/$scope.pagination.limit),angular.forEach($scope.results,function(result){result._source.price=parseFloat(result._source.price),result._source.price=result._source.price.toFixed(2),result._source.slug=slugify(result._source.title)}),$rootScope.titleLine='Search results for "'+searchTerm+'"'+$rootScope.titleSep1+$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead})},$scope.selectAllResults=function(count,search,sort,order,filter){console.log(count+" - "+search+" - "+sort+" - "+order+" - "+filter)},$scope.searchPage=function(arg,searchTerm){$scope.searchLoading=!0,"next"==arg&&($scope.pagination.page=$scope.pagination.page+1),"prev"==arg&&($scope.pagination.page=$scope.pagination.page-1),"first"==arg&&($scope.pagination.page=0),"last"==arg&&($scope.pagination.page=$scope.pagination.pages-1),$scope.getResults(searchTerm)},$scope.sortResults=function(index,searchTerm){$scope.currentSortMethod=$scope.sortMethods[index],$cookieStore.put("currentSortMethod",index),$scope.searchLoading=!0,$scope.getResults(searchTerm)},$scope.sortDirection=function(arg,searchTerm){$scope.sortOrder=arg,$cookieStore.put("sortOrder",$scope.sortOrder),$scope.searchLoading=!0,$scope.getResults(searchTerm)},$scope.gotoDetail=function(index){$cookieStore.put("detailSource",{page:$scope.pageSlug,source:$scope.searchedFor,pos:index,total:$scope.total,sort:$scope.currentSortMethod.slug,order:$scope.sortOrder,filter:$scope.filter})}}]);var ctrl=angular.module("detail",[]);ctrl.controller("detailController",["$scope","$rootScope","$http","$location","$routeParams","$cookieStore","searchify","slugify","orderByFilter","$timeout","focus",function($scope,$rootScope,$http,$location,$routeParams,$cookieStore,searchify,slugify,orderByFilter,$timeout,focus){if($rootScope.pageSlug="detail",$rootScope.pageTitle="Detail",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead,$(".container").scrollTop(0),$scope.detail={},$scope.detailLoading=!0,$scope.getDetail=function(id){$http.post("/detail/id",{id:id}).success(function(detail){$scope.detail=detail,$rootScope.titleLine=$scope.detail.title+$rootScope.titleSep1+$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead,$scope.detailLoading=!1})},$scope.gotoDetail=function(arg){"prev"==arg&&($scope.detailSource.pos=$scope.detailSource.pos-1),"next"==arg&&($scope.detailSource.pos=$scope.detailSource.pos+1),$cookieStore.put("detailSource",$scope.detailSource)},$scope.detailSource=$cookieStore.get("detailSource"),"search"==$scope.detailSource.page){var searchified=searchify($scope.detailSource.source);$scope.detailSource.url="search/"+searchified,$scope.detailSource.line="Search results: <em>"+$scope.detailSource.source+"</em>",$http.post("/search/results",{search:$scope.detailSource.source,page:$scope.detailSource.pos,limit:3,sort:$scope.detailSource.sort,order:$scope.detailSource.order,filter:$scope.detailSource.filter,mark:"detail"}).success(function(response){$scope.nextDetail=response.hits.hits[2],$scope.prevDetail=response.hits.hits[0],0==$scope.detailSource.pos&&($scope.nextDetail=response.hits.hits[1]),$scope.nextDetail&&($scope.nextDetail.slug=slugify($scope.nextDetail._source.title)),$scope.prevDetail&&($scope.prevDetail.slug=slugify($scope.prevDetail._source.title))})}if("cart"==$scope.detailSource.page){var slugified=searchify($scope.detailSource.source);$scope.detailSource.url="cart/"+slugified+"/"+$scope.detailSource.id,$scope.detailSource.line="Shopping cart: <em>"+$scope.detailSource.source+"</em>",$scope.cartDetail={},$http.post("/carts/detail",{id:$scope.detailSource.id}).success(function(cart){$scope.cartDetail=cart,$scope.cartDetail.books=orderByFilter($scope.cartDetail.books,"-added");var next=$scope.detailSource.pos+1,prev=$scope.detailSource.pos-1;$scope.nextDetail=$scope.cartDetail.books[next],$scope.prevDetail=$scope.cartDetail.books[prev],$scope.nextDetail&&($scope.nextDetail.slug=slugify($scope.nextDetail.book.title),$scope.nextDetail._id=$scope.nextDetail.book._id),$scope.prevDetail&&($scope.prevDetail.slug=slugify($scope.prevDetail.book.title),$scope.prevDetail._id=$scope.prevDetail.book._id)})}var timer=!1;$scope.updateCart=function(){timer&&$timeout.cancel(timer),timer=$timeout(function(){$http.post("/carts/update",$scope.cartDetail).success(function(response){response._id==$rootScope.activeCart._id&&$rootScope.getActiveCart(response._id)})},500)},$scope.currentRef=!1,$scope.setCurrentRef=function(arg){$scope.currentRef=arg,focus("ref-"+arg)},$scope.blurCurrentRef=function(){$scope.currentRef=!1},$scope.keypressCurrentRef=function($event){13==$event.keyCode&&($scope.currentRef=!1)},$routeParams.id&&$scope.getDetail($routeParams.id)}]);var ctrl=angular.module("advanced",[]);ctrl.controller("advancedController",["$scope","$rootScope","$http","$location",function($scope,$rootScope){$rootScope.pageSlug="advanced",$rootScope.pageTitle="Advanced search",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);var ctrl=angular.module("outside",[]);ctrl.controller("outsideController",["$scope","$rootScope","$http","$location",function($scope,$rootScope){$rootScope.pageSlug="outside",$rootScope.pageTitle="Order outside database",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);var ctrl=angular.module("isbn",[]);ctrl.controller("isbnController",["$scope","$rootScope","$http","$location",function($scope,$rootScope){$rootScope.pageSlug="isbn",$rootScope.pageTitle="ISBN upload",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);var ctrl=angular.module("tracing",[]);ctrl.controller("tracingController",["$scope","$rootScope","$http","$location",function($scope,$rootScope){$rootScope.pageSlug="tracing",$rootScope.pageTitle="Order tracing",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);var ctrl=angular.module("standing",[]);ctrl.controller("standingController",["$scope","$rootScope","$http","$location",function($scope,$rootScope){$rootScope.pageSlug="standing",$rootScope.pageTitle="Standing orders and journals",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);var ctrl=angular.module("nts",[]);ctrl.controller("ntsController",["$scope","$rootScope","$http","$location",function($scope,$rootScope){$rootScope.pageSlug="nts",$rootScope.pageTitle="New title service",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);var ctrl=angular.module("approval",[]);ctrl.controller("approvalController",["$scope","$rootScope","$http","$location",function($scope,$rootScope){$rootScope.pageSlug="approval",$rootScope.pageTitle="Approval plans",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);var ctrl=angular.module("profile",[]);ctrl.controller("profileController",["$scope","$rootScope",function($scope,$rootScope){$rootScope.pageSlug="profile",$rootScope.pageTitle="Profile",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead,$scope.subMenu=[{name:"Information",slug:"overview",url:"/partials/profile/overview"},{name:"Accounts",slug:"accounts",url:"/partials/profile/accounts"},{name:"Activity",slug:"activity",url:"/partials/profile/activity"}],$scope.currentPage=$scope.subMenu[0],$scope.gotoPage=function(option){$scope.currentPage=option}}]),ctrl.controller("profileOverview",["$scope","$rootScope","$http","$timeout",function($scope,$rootScope,$http,$timeout){$rootScope.pageSubtitle="Information",$rootScope.titleLine=$rootScope.pageSubtitle+$rootScope.titleSep1+$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead,$scope.updated=!1,$scope.noMatch=!1,$scope.confirmPassword=function(){$timeout(function(){$scope.noMatch=$scope.confirm&&$rootScope.user.password!=$scope.confirm?!0:!1},1)},$scope.updateUser=function(user){return $rootScope.user.password&&$rootScope.user.password!=$scope.confirm?alert("Password do not match"):($scope.updated="waiting",void $http.post("/users/update",user).success(function(response){$scope.updated=response.success,$rootScope.user.password="",$rootScope.reloadEverything(),$scope.confirm="",$timeout(function(){$scope.updated=!1},3e3)}))}}]),ctrl.controller("profileActivity",["$scope","$rootScope","$http",function($scope,$rootScope){$rootScope.pageSubtitle="Activity",$rootScope.titleLine=$rootScope.pageSubtitle+$rootScope.titleSep1+$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);var ctrl=angular.module("help",[]);ctrl.controller("helpController",["$scope","$rootScope","$http","$location",function($scope,$rootScope){$rootScope.pageSlug="help",$rootScope.pageTitle="Help",$rootScope.pageSubtitle="",$rootScope.titleLine=$rootScope.pageTitle+$rootScope.titleSep2+$rootScope.masthead}]);